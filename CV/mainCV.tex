...
\newcommand{\fr}{\includegraphics[scale=0.02]{fr.png}}
\newcommand{\dz}{\includegraphics[scale=0.02]{dz.png}}
\newcommand{\kab}{\includegraphics[scale=0.02]{kab.png}}

\newcommand{\web}{\includegraphics[scale=0.15]{web.png}}
\newcommand{\email}{\includegraphics[scale=0.15]{email.png}}
\newcommand{\phone}{\includegraphics[scale=0.15]{phone.png}}
